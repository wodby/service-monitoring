# Monitoring service for Wodby

Use Monitoring as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Monitoring service in the Wodby catalog.

- [Monitoring service in the Wodby catalog](https://wodby.com/services/monitoring)
...
4. Reference `monitoring` from your stack manifest.
